...
export const USER_REGISTRY_ADDRESS = process.env.REACT_APP_USER_REGISTRY_ADDRESS;
export const FREELANCE_ESCROW_ADDRESS = process.env.REACT_APP_FREELANCE_ESCROW_ADDRESS;